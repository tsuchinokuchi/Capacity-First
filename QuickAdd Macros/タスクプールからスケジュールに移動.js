// QuickAdd Macro: タスクプールからスケジュールに移動
// 使い方: QuickAddの設定画面でこのMacroを追加

const QuickAdd = params;

// 設定
const TASK_POOL_PATH = "03.ツェッテルカステン/030.データベース/タスク管理/タスクプール/タスクプール.md";
...
async function main() {
  try {
    ...
    const selectedTaskLabel = await QuickAdd.quickAddApi.suggester(
      taskLabels,
      taskLabels
    );
