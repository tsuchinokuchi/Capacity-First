...
module.exports = async (params) => {
  ...
  const DAILY_TASKS_PATH = `${PATHS.BASE}/繰り返しタスク/毎日.md`;
  const WEEKLY_TASKS_PATH = `${PATHS.BASE}/繰り返しタスク/毎週.md`;
  const MONTHLY_TASKS_PATH = `${PATHS.BASE}/繰り返しタスク/毎月.md`;
  const LAST_EXECUTED_PATH = `${PATHS.BASE}/.last_monthly_expand`;
